...
Cada Matrix 25 se entrega con inspección de Prefectura Naval Argentina y documentación completa para su matriculación.`,
  ...
  {
    id: 'panga-cruiser-24',
    name: 'Panga Cruiser 24',
    tagline: 'Confort de paseo con toldo bimini y cubierta de teca.',
    image: '/boat_model_4.png',
    images: [
      '/boat_model_4.png',
      '/hero_boat.png',
      '/shipyard.png',
    ...
    specs: {
      ...
      beam: '2.45 m',
      capacity: '9 personas',
      engine: '115 HP - 175 HP',
      hull: 'Fibra de vidrio',
      weight: '780 kg',
    },
    description: `La Panga Cruiser 24 está pensada para el paseo familiar y las tardes de navegación relajada por el Delta. Su cubierta de teca sintética y el amplio toldo bimini ofrecen sombra y confort durante todo el día.

El diseño de proa abierta con solárium y asientos envolventes crea un espacio social ideal para compartir con amigos y familia, sin resignar la estabilidad y seguridad que caracteriza a toda la línea Panga.

Equipada de serie con heladera bajo asiento, ducha de proa y equipo de sonido, es la opción predilecta de quienes buscan disfrutar el río con estilo.`,
    features: [
      'Cubierta de teca sintética antideslizante',
      'Toldo bimini de gran tamaño',
      'Solárium de proa con asientos envolventes',
      'Heladera bajo asiento de serie',
      'Ducha de proa con agua dulce',
      'Equipo de sonido integrado',
    ],
    instagramLink: 'https://instagram.com/panga.arg',
  },
];
